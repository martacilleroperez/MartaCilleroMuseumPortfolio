...
const PROJECTS = [
    ...
    {
    id: "tesis",
    title: "Generative AI & Cultural Heritage ",
    blurb: "Analysis of generative AI methodologies for the analysis and the recontruction of Rome’s carnival.",
    images: [
